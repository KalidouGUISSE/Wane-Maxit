...
class UtilisateurRepository extends AbstractRepository {
    ...
    public function insert(string $telephone, string $nci, string $nom, string $prenom, string $adresse, ?array $photoRecto, ?array $photoVerso): int {
        try {
            ...
            // Requête d’insertion
            $sqlUser = "INSERT INTO utilisateur (nom, prenom, num_tel, nci, adresse, photo_recto, photo_verso)
                        VALUES (:nom, :prenom, :telephone, :nci, :adresse, :photo_recto, :photo_verso)";
